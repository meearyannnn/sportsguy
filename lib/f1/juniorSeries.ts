...
export const JUNIOR_SERIES_DATABASE: Record<'f2' | 'f3' | 'academy', JuniorSeriesData> = {
  f2: {
    ...
    drivers: [
      { id: 'miyata', name: 'Ritomo Miyata', code: 'MIY', number: 3, country: 'Japan', countryFlag: '🇯🇵', team: 'Hitech Pulse-Eight', f1Academy: 'Toyota Gazoo Racing', f1AcademyColor: '#E8002D', points: 154, position: 1, wins: 4, podiums: 7, poles: 2, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/hitech/ritmiy01/2026hitechritmiy01right.webp', bio: 'Super Formula and Super GT Champion who made an explosive transition to European racing with Hitech.' },
      { id: 'herta', name: 'Colton Herta', code: 'HER', number: 4, country: 'United States', countryFlag: '🇺🇸', team: 'Hitech Pulse-Eight', f1Academy: 'Cadillac F1 Target', f1AcademyColor: '#FFC72C', points: 142, position: 2, wins: 3, podiums: 6, poles: 3, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/hitech/colher01/2026hitechcolher01right.webp', bio: 'IndyCar superstar and youngest winner in IndyCar history, competing in FIA F2 to earn F1 Super Licence points.' },
      { id: 'beganovic', name: 'Dino Beganovic', code: 'BEG', number: 1, country: 'Sweden', countryFlag: '🇸🇪', team: 'DAMS Lucas Oil', f1Academy: 'Ferrari Driver Academy', f1AcademyColor: '#E8002D', points: 138, position: 3, wins: 2, podiums: 6, poles: 2, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/damslucasoil/dinbeg01/2026damslucasoildinbeg01right.webp', bio: 'FRECA Champion and Ferrari Driver Academy protege stepping up to F2 with DAMS.' },
      { id: 'durksen', name: 'Joshua Dürksen', code: 'DUR', number: 24, country: 'Paraguay', countryFlag: '🇵🇾', team: 'Invicta Racing', f1Academy: 'Independent Sensation', f1AcademyColor: '#3671C6', points: 112, position: 4, wins: 2, podiums: 4, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/invictaracing/josdur01/2026invictaracingjosdur01right.webp', bio: 'Paraguayan trailblazer who captured historic F2 Feature Race victory at Baku.' },
      { id: 'leon', name: 'Noel León', code: 'LEO', number: 14, country: 'Mexico', countryFlag: '🇲🇽', team: 'Campos Racing', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#3671C6', points: 98, position: 5, wins: 1, podiums: 5, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/camposracing/noeleo01/2026camposracingnoeleo01right.webp', bio: 'Euroformula Champion and Red Bull Junior driver impressing with Campos Racing.' },
      { id: 'maini', name: 'Kush Maini', code: 'MAI', number: 9, country: 'India', countryFlag: '🇮🇳', team: 'ART Grand Prix', f1Academy: 'Alpine Academy', f1AcademyColor: '#0090FF', points: 95, position: 6, wins: 1, podiums: 4, poles: 2, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/artgrandprix/kusmai01/2026artgrandprixkusmai01right.webp', bio: 'Alpine Academy driver and Formula 2 winner from India delivering high-speed qualifying laps.' },
      { id: 'mini', name: 'Gabriele Minì', code: 'MIN', number: 11, country: 'Italy', countryFlag: '🇮🇹', team: 'MP Motorsport', f1Academy: 'Alpine Academy', f1AcademyColor: '#0090FF', points: 88, position: 7, wins: 2, podiums: 4, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/mpmotorsport/gabmin01/2026mpmotorsportgabmin01right.webp', bio: 'Monaco F3 winner and Alpine Academy Italian prodigy stepping up into F2.' },
      { id: 'goethe', name: 'Oliver Goethe', code: 'GOE', number: 12, country: 'Germany', countryFlag: '🇩🇪', team: 'MP Motorsport', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#3671C6', points: 84, position: 8, wins: 1, podiums: 4, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/mpmotorsport/oligoe01/2026mpmotorsportoligoe01right.webp', bio: 'Red Bull Junior driver with dominant race victories across European circuits.' },
      { id: 'montoya', name: 'Sebastian Montoya', code: 'MOY', number: 5, country: 'Colombia', countryFlag: '🇨🇴', team: 'PREMA Racing', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#3671C6', points: 76, position: 9, wins: 1, podiums: 3, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/premaracing/sebmon01/2026premaracingsebmon01right.webp', bio: 'Son of F1 icon Juan Pablo Montoya, showcasing aggressive wheel-to-wheel racing for PREMA.' },
      { id: 'bilinski', name: 'Roman Bilinski', code: 'BIL', number: 21, country: 'Poland', countryFlag: '🇵🇱', team: 'DAMS Lucas Oil', f1Academy: 'FR Oceania Champion', f1AcademyColor: '#FF8000', points: 64, position: 10, wins: 1, podiums: 2, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/damslucasoil/rombil01/2026damslucasoilrombil01right.webp', bio: 'Formula Regional Oceania Champion who established himself as a Feature Race contender.' },
    ],
    teams: [
    ...
    calendar: [
      ...
      { round: 6, gpName: 'Spanish Grand Prix', circuit: 'Circuit de Barcelona-Catalunya', countryFlag: '🇪🇸', date: '21 JUN – 23 JUN', isCompleted: true, sprintWinner: 'Sebastian Montoya', featureWinner: 'Ritomo Miyata', polePosition: 'Kush Maini', fastestLap: 'Ritomo Miyata' },
  ...
  f3: {
    ...
    drivers: [
      { id: 'slater', name: 'Freddie Slater', code: 'SLA', number: 2, country: 'United Kingdom', countryFlag: '🇬🇧', team: 'Trident', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#3671C6', points: 145, position: 1, wins: 4, podiums: 7, poles: 3, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/trident/fresla01/2026tridentfresla01right.webp', bio: 'Italian F4 champion and karting legend who took the F3 championship by storm with Trident.' },
      { id: 'taponen', name: 'Tuukka Taponen', code: 'TAP', number: 3, country: 'Finland', countryFlag: '🇫🇮', team: 'MP Motorsport', f1Academy: 'Ferrari Driver Academy', f1AcademyColor: '#E8002D', points: 109, position: 2, wins: 3, podiums: 5, poles: 2, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/mpmotorsport/tuutap01/2026mpmotorsporttuutap01right.webp', bio: 'Finnish flying sensation and Ferrari protege with wins at Spa and Red Bull Ring.' },
      { id: 'ugochukwu', name: 'Ugo Ugochukwu', code: 'UGO', number: 1, country: 'United States', countryFlag: '🇺🇸', team: 'Campos Racing', f1Academy: 'McLaren Driver Development', f1AcademyColor: '#FF8000', points: 102, position: 3, wins: 2, podiums: 5, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/camposracing/ugougo01/2026camposracingugougo01right.webp', bio: 'Macau Grand Prix winner and McLaren Young Driver prodigy.' },
      { id: 'camara', name: 'Rafael Câmara', code: 'CAM', number: 4, country: 'Brazil', countryFlag: '🇧🇷', team: 'Invicta Racing', f1Academy: 'Ferrari Driver Academy', f1AcademyColor: '#E8002D', points: 94, position: 4, wins: 2, podiums: 4, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/invictaracing/rafcam01/2026invictaracingrafcam01right.webp', bio: 'FRECA Champion and Brazilian Ferrari Academy sensation.' },
      { id: 'boya', name: 'Mari Boya', code: 'BOY', number: 10, country: 'Spain', countryFlag: '🇪🇸', team: 'PREMA Racing', f1Academy: 'Aston Martin Driver Development', f1AcademyColor: '#229971', points: 88, position: 5, wins: 1, podiums: 4, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/premaracing/marboy01/2026premaracingmarboy01right.webp', bio: 'Spanish Feature Race winner with PREMA Racing.' },
      { id: 'tsolov', name: 'Nikola Tsolov', code: 'TSO', number: 11, country: 'Bulgaria', countryFlag: '🇧🇬', team: 'Campos Racing', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#3671C6', points: 82, position: 6, wins: 2, podiums: 3, poles: 1, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/camposracing/niktso01/2026camposracingniktso01right.webp', bio: 'The Bulgarian Lion known for fearless overtaking maneuvers.' },
      { id: 'nael', name: 'Théophile Naël', code: 'NAE', number: 7, country: 'France', countryFlag: '🇫🇷', team: 'Campos Racing', f1Academy: 'Spanish F4 Champion', f1AcademyColor: '#27F4D2', points: 76, position: 7, wins: 1, podiums: 3, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/camposracing/thenae01/2026camposracingthenae01right.webp', bio: 'Spanish F4 Champion impressing in FIA F3 with Campos Racing.' },
      { id: 'stromsted', name: 'Noah Strømsted', code: 'STR', number: 5, country: 'Denmark', countryFlag: '🇩🇰', team: 'Trident', f1Academy: 'Independent Star', f1AcademyColor: '#0090FF', points: 71, position: 8, wins: 1, podiums: 3, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/trident/noastr01/2026tridentnoastr01right.webp', bio: 'Danish single-seater standout driving for Trident.' },
      { id: 'inthraphuvasak', name: 'Tasanapol Inthraphuvasak', code: 'INT', number: 25, country: 'Thailand', countryFlag: '🇹🇭', team: 'ART Grand Prix', f1Academy: 'Thai Racing Pioneer', f1AcademyColor: '#64C4FF', points: 65, position: 9, wins: 1, podiums: 2, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f2/2026/artgrandprix/tasint01/2026artgrandprixtasint01right.webp', bio: 'Sprint Race winner at Hungaroring for ART Grand Prix.' },
      { id: 'rivera', name: 'Ernesto Rivera', code: 'RIV', number: 18, country: 'Mexico', countryFlag: '🇲🇽', team: 'Campos Racing', f1Academy: 'Red Bull Junior Team', f1AcademyColor: '#E8002D', points: 58, position: 10, wins: 0, podiums: 2, poles: 0, headshotUrl: 'https://res.cloudinary.com/prod-f2f3/image/upload/c_lfill,w_440/q_auto/v1770000000/common/f3/2026/camposracing/ernriv01/2026camposracingernriv01right.webp', bio: 'Consistent points scorer in his debut F3 season.' },
    ],
    teams: [
