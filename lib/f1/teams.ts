...
export const F1_TEAMS: Record<string, TeamMeta> = {
  ferrari: {
    ...
    technicalChief: 'Loïc Serra (Chassis) / Enrico Gualtieri (PU)',
    chassis: 'SF-26',
    firstEntry: '1950',
    championships: 16,
    allTimeWins: 248,
  ...
  mclaren: {
    ...
    technicalChief: 'Rob Marshall (Chief Designer) / Peter Prodromou (Aero)',
    chassis: 'MCL39',
    firstEntry: '1966',
    championships: 9,
    allTimeWins: 189,
  ...
  aston_martin: {
    ...
    technicalChief: 'Adrian Newey (Managing Technical Partner) / Enrico Cardile',
    chassis: 'AMR26',
    firstEntry: '1959',
    championships: 0,
    allTimeWins: 1,
  ...
  audi: {
    ...
    technicalChief: 'Mattia Binotto (COO/CTO) / James Key',
    chassis: 'C45',
    firstEntry: '1993',
    championships: 0,
    allTimeWins: 1,
